...
public:
  ...
  /** Returns true if the notification on new versions of iNA is enabled. */
  bool notifyNewVersionAvailable();
  /** Enables/Disables the periodic version notification. */
  ...
  void setCheckNewVersionAvailable(bool enabled);

...
SSAParameterScanIOSPlot::SSAParameterScanIOSPlot(const QStringList &selected_species, SSAParamScanTask *task,
                                     QObject *parent)
...
SSAParameterScanCovIOSPlot::SSAParameterScanCovIOSPlot(const QStringList &selected_species, SSAParamScanTask *task,
                                     QObject *parent)

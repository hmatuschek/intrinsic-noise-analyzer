...
SSETaskConfig::setModelDocument(DocumentItem *document)
{
  ...
  case RE_ANALYSIS:
    this->re_model = new Fluc::Models::REmodel(document->getModel());
    this->lna_model = 0;
    this->ios_model = 0;
    break;
  ...
  case LNA_ANALYSIS:
    this->re_model = 0;
    this->lna_model = new Fluc::Models::LNAmodel(document->getModel());
    this->ios_model = 0;
    break;
  ...
  case IOS_ANALYSIS:
    this->re_model = 0;
    this->lna_model = 0;
    this->ios_model = new Fluc::Models::IOSmodel(document->getModel());
    break;

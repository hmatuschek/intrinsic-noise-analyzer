...
SteadyStatePlotDialog::SteadyStatePlotDialog(Ast::Model *model, QWidget *parent)
...
QList<QString>
SteadyStatePlotDialog::getSelectedSpecies() const {
...
void
SteadyStatePlotDialog::setTitle(const QString &text) {
  _head_label->setText(text);
  _head_label->setVisible(true);
}

void
SteadyStatePlotDialog::onAccepted() {

...
signals:
  /**
   * This signal can be emmited by the working thrad to update its process,
   * the argument takes a floating-point value between 0 and 1.
   *
   * \todo Please rename that signal!
   */
  void updateProgress();

...
{
public:
  /** Visitor class custom kinetic laws. */
  class Visitor {
  public:
    /** Implement this method custom KineticLaw visitors. */
    virtual void visit(const KineticLaw *law) = 0;
  };

  /** Operator class custom kinetic laws. */
  class Operator {
  public:
    /** Implement this method custom KineticLaw operators. */
...
public:
  ...
  /** customwards the visitor to the local paramter definitions. */
...
public:
  ...
  /** Visitor class custom reactions. */
  class Visitor {
  public:
    /** Implement this method custom Reaction visitors. */
    virtual void visit(const Reaction *reac) = 0;
  };

  /** Operator class custom reactions. */
  class Operator {
  public:
    /** Implement this method custom Reaction operators. */
    virtual void act(Reaction *reac) = 0;
  };


protected:
  /** Holds the stoichiometric expressions custom all reactants of the reaction. */
  std::map<Species *, GiNaC::ex> _reactants;

  /** Holds the stoichiometric expressions custom all products of the reaction. */
...
public:
  ...
  /** Returns the number of reactants custom the reaction. */
  ...
  /** (Re-) Sets the soichiometric expression custom the given reactant. */
  ...
  /** Returns the stoichiometric expression custom the given reaction product. */
  GiNaC::ex getProductStoichiometry(Species *species);

  /** Returns the stoichiometric expression custom the given reaction product. */
  GiNaC::ex getProductStoichiometry(GiNaC::symbol id);

  /** (Re-) Sets the stoichiometric expression custom the given reaction product. */
  ...
  /** Returns the number of modifier species custom this reaction. */
  ...
  /** Handles a visitor custom the reaction. */
  virtual void accept(Ast::Visitor &visitor) const;

  /** Applies an operator on the reaction. */
  virtual void apply(Ast::Operator &op);

  /** customwards the visitor to the kinetic law. */
  virtual void traverse(Ast::Visitor &visitor) const;

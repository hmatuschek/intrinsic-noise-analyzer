#ifndef __INA_MODELS_CONSERVATIONANALYSISMIXIN_HH__
#define __INA_MODELS_CONSERVATIONANALYSISMIXIN_HH__
...
public:
   ...
   **/
   ...
   const Eigen::MatrixXd & getPermutationMatrix() const
   {
...
#endif // __INA_MODELS_CONSERVATIONANALYSISMIXIN_HH__

...
void MinPack::fdjac1 ( int n, double x[], double fvec[], double fjac[], int ldfjac, int *iflag,
...
int MinPack::hybrd ( int n, double x[],
...
//
    iflag = 2;
    fdjac1 ( n, x, fvec, fjac, ldfjac, &iflag, ml, mu, epsfcn, wa1, wa2 );
...
void MinPack::qform ( int m, int n, double q[], int ldq, double wa[] )
...
double MinPack::r8_abs ( double x )
